...
class DoctorSearchView(APIView):
    def get(self, request, format=None):
        ...
        doctors = Doctor.objects.filter(nom__icontains=nom, specialite__nom__icontains=specialite)
...
class AppointmentSearchView(APIView):
    def get(self, request, format=None):
        ...
        appointments = Appointment.objects.filter(doctor_id=doctor_id, patient_id=patient_id, date=date)
